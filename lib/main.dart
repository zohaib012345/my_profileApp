...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> skillList = ["Android","Flutter","Java","Dart","Restfull API","XML",
    "JSON","XML","Firebase","Git","Sockets"];
  ...
  Widget build(BuildContext context) {
    degreeList.clear();
    projectList.clear();
    degreeList.add(Degree("BS-Software Engineering","University of Karachi","2016-2019"));
    degreeList.add(Degree("Intermediate","Govt College of Sci & Comm","2012-2014"));
                  ...
                  child:Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: CircleAvatar(
                            backgroundImage:
                            NetworkImage('https://images.unsplash.com/photo-1547721064-da6cfb341d50?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80',
                            ),
                          )
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                return DegreeViewWidget(degreeList.elementAt(index));
                              }
                          ),
                        ),
                        SizedBox(
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              //scrollDirection: Axis.horizontal,
                              itemBuilder: (BuildContext context, int index) {
                                return ProjectViewWidget(projectList.elementAt(index));
                              }),
                        ),
                      ],
                    ),
